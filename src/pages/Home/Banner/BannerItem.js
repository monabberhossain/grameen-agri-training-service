...
const BannerItem = ({ slide }) => {
    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            >
                <Link className="btn btn-success btn-outline hover:bg-orange-400 mt-20">
                    Enroll To Courses
                </Link>
            </div>
            ...
            <div className="absolute flex justify-center transform -translate-y-1/2 left-5 right-5 bottom-1">
                <a
                    href={`#slide${prev}`}
                    className="btn btn-success btn-outline  hover:bg-orange-400 btn-circle mr-5"
                >
                    ❮❮
                </a>
                <a
                    href={`#slide${next}`}
                    className="btn btn-success btn-outline  hover:bg-orange-400 btn-circle"
                >
                    ❯❯
                </a>
            </div>
